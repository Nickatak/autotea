...
class TemperatureReader:
    ...
    def __init__(self, fail_loud=True):
        ...
        try:
            ...
            raise IOError("Could not locate device interface.  Please see the following link to make sure you've enbaled 1-wire interfaces: https://www.raspberrypi-spy.co.uk/2013/03/raspberry-pi-1-wire-digital-thermometer-sensor/.") from e
